...
export const getRecruitUnitsUrl = (townId: number,) => {
 ...
 */
export const recruitUnits = async (townId: number,
    recruitOrder: RecruitOrder, options?: RequestInit): Promise<Army> => {

  return customFetch<Army>(getRecruitUnitsUrl(townId),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getRecruitUnitsMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof recruitUnits>>, TError,{townId: number;data: BodyType<RecruitOrder>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof recruitUnits>>, TError,{townId: number;data: BodyType<RecruitOrder>}, TContext> => {

const mutationKey = ['recruitUnits'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof recruitUnits>>, {townId: number;data: BodyType<RecruitOrder>}> = (props) => {
          const {townId,data} = props ?? {};

          return  recruitUnits(townId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RecruitUnitsMutationResult = NonNullable<Awaited<ReturnType<typeof recruitUnits>>>
    export type RecruitUnitsMutationBody = BodyType<RecruitOrder>
    export type RecruitUnitsMutationError = ErrorType<void>

    /**
 * @summary Recruit units (costs resources)
 */
export const useRecruitUnits = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof recruitUnits>>, TError,{townId: number;data: BodyType<RecruitOrder>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof recruitUnits>>,
        TError,
